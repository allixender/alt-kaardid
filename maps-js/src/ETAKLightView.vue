...
// {url:"https://maps.landscape-geoinformatics.org/geoserver/geodb/wms",attributions:_,params:{LAYERS:"geodb:ETAK_dark",TILED:!0},serverType:"geoserver",transition:0}
// {url:"https://maps.landscape-geoinformatics.org/geoserver/geodb/wms",attributions:_,params:{LAYERS:"geodb:ETAK_light",TILED:!0},serverType:"geoserver",transition:0}
// {url:"https://maps.landscape-geoinformatics.org/geoserver/geodb/wms",attributions:_,params:{LAYERS:"geodb:ETAK_OSM_labels"},serverType:"geoserver"}

// ol source WMS setup:
const wms_source = new TileWMS({
  url: "https://maps.landscape-geoinformatics.org/geoserver/geodb/wms",
  params: {
    LAYERS: "geodb:ETAK_light",
    TILED: true,
  },
...
const labels_wms_source = new ImageWMS({
  url: "https://maps.landscape-geoinformatics.org/geoserver/geodb/wms",
  params: {
    LAYERS: "geodb:ETAK_light_labels",
  },
  serverType: "geoserver",
  ratio: 1,
