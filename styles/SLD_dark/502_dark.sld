...
<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xsi:schemaLocation="http://www.opengis.net/sld http://schemas.opengis.net/sld/1.1.0/StyledLayerDescriptor.xsd" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:se="http://www.opengis.net/se" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ogc="http://www.opengis.net/ogc" version="1.1.0">
  <NamedLayer>
    <se:Name>E_502_roobastee_j</se:Name>
    <UserStyle>
      <se:Name>E_502_roobastee_j</se:Name>
      <se:FeatureTypeStyle>
        <se:Rule>
          <se:Name>korval</se:Name>
          <se:Description>
            <se:Title>korval</se:Title>
          </se:Description>
        ...
        <se:Rule>
          <se:Name>pohisuur</se:Name>
          <se:Description>
            <se:Title>pohisuur</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tahtsus</ogc:PropertyName>
        ...
        <se:Rule>
          <se:Name>pohi</se:Name>
          <se:Description>
            <se:Title>pohi</se:Title>
          </se:Description>
          <ogc:Filter xmlns:ogc="http://www.opengis.net/ogc">
            <ogc:PropertyIsEqualTo>
              <ogc:PropertyName>tahtsus</ogc:PropertyName>
